...
mode = st.sidebar.radio('Game Mode', ['Single player', 'Battle Royale', 'Co-operative', 'Massively Multiplayer Online (MMO)', 'Multiplayer', 'Split screen'])
genre = st.sidebar.selectbox('Genre', ['Adventure', 'Arcade', 'Card & Board Game',
